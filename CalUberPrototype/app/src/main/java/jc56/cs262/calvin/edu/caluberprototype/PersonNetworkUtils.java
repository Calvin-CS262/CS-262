...
public class PersonNetworkUtils {
    private static final String LOG_TAG = PersonNetworkUtils.class.getSimpleName();
    private static final String PERSON_LIST_URL = "https://caluber-221319.appspot.com/caluber/v1/persons";
    private static final String PERSON_ID_URL = "https://caluber-221319.appspot.com/caluber/v1/person/";
    private static final String PERSON_POST_URL = "https://caluber-221319.appspot.com/caluber/v1/persons";
    private static final String PERSON_DELETE_URL = "https://caluber-221319.appspot.com/caluber/v1/person/";
    private static final String PERSON_PUT_URL = "https://caluber-221319.appspot.com/caluber/v1/person/";
     ...
     */
    static String postPersonInfo(String personId, String email, String password,
                                 String lastName, String firstName) {
        HttpURLConnection urlConnection = null;
        BufferedReader reader = null;

        try {
            Uri buildURI = Uri.parse(PERSON_POST_URL).buildUpon().build();
            //Convert URI to URL
